...
/*
 Add a WHERE clause to restrict the result table to sales from Colorado and Oklahoma only.
 Use the MONTH() and YEAR() functions to select only sales in month 2 and year 2020
 */