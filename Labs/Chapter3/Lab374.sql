...
/*
 Use a modified query that sums the quantity and sales price for each book using the SUM() function.
 The GROUP BY clause groups the sums together for each book ID and state. The ORDER BY clause sorts
 the total sales in descending order.
 */